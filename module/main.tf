...
##
# Circuit-breaker state machine log group
##
...
##
# Circuit-breaker state machine role assume policy
##
...
##
# Circuit-breaker state machine role log group permissions policy document
##
...
##
# Circuit-breaker state machine role lambda invoke permissions policy document
##
...
##
# Circuit-breaker state machine role log group IAM policy
##
...
##
# Circuit-breaker state machine role lambda invoke IAM policy
##
...
##
# Circuit-breaker state machine IAM Role
##
